...
dataDictV9_2018 = {
    'dataPostVFP' : { 
        'filepaths' : [ "{BASE_PATH}/../y2018v6/SingleMuon/NanoV9Run2018A_{NANO_PROD_TAG}",
    ...
    'SingleTtchanAntitopPostVFP' : { 
        'filepaths' : ["{BASE_PATH}/../y2018v6/ST_t-channel_antitop_5f_InclusiveDecays_TuneCP5_13TeV-powheg-pythia8/NanoV9MC2018_{NANO_PROD_TAG}"],
        'xsec' : 80.0,
        'group' : "Top",
    ...
    'SingleTtchanTopPostVFP' : { 
        'filepaths' : ["{BASE_PATH}/../y2018v6/ST_t-channel_top_5f_InclusiveDecays_TuneCP5_13TeV-powheg-pythia8/NanoV9MC2018_{NANO_PROD_TAG}"],
        'xsec' : 134.2,
        'group' : "Top",
    ...
    ##
    'WWTo2L2NuPostVFP' : { 
        'filepaths' : ["{BASE_PATH}/../y2018v6/WWTo2L2Nu_TuneCP5_13TeV-powheg-pythia8/NanoV9MC2018_{NANO_PROD_TAG}"],
    ...
    'WWTo1L1Nu2QPostVFP' : { 
        'filepaths' : ["{BASE_PATH}/../y2018v6/WWTo1L1Nu2Q_4f_TuneCP5_13TeV-amcatnloFXFX-pythia8/NanoV9MC2018_{NANO_PROD_TAG}"],
    ...
    'WZTo3LNuPostVFP' : { 
        'filepaths' : ["{BASE_PATH}/../y2018v6/WZTo3LNu_TuneCP5_13TeV-amcatnloFXFX-pythia8/NanoV9MC2018_{NANO_PROD_TAG}"],
    ...
    'WZTo2Q2LPostVFP' : { 
        'filepaths' : ["{BASE_PATH}/../y2018v6/WZTo2Q2L_mllmin4p0_TuneCP5_13TeV-amcatnloFXFX-pythia8/NanoV9MC2018_{NANO_PROD_TAG}"],
    ...
    'WZTo1L1Nu2QPostVFP' : { 
        'filepaths' : ["{BASE_PATH}/../y2018v6/WZTo1L1Nu2Q_4f_TuneCP5_13TeV-amcatnloFXFX-pythia8/NanoV9MC2018_{NANO_PROD_TAG}"],
    ...
    'ZZTo2L2NuPostVFP' : { 
        'filepaths' : ["{BASE_PATH}/../y2018v6/ZZTo2L2Nu_TuneCP5_13TeV_powheg_pythia8/NanoV9MC2018_{NANO_PROD_TAG}"],
        'xsec' : 0.60,
        'group' : "Diboson",
