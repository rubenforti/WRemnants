...
dataDictV9_2017 = {
    'dataPostVFP' : { 
        'filepaths' : [ "{BASE_PATH}/../y2017v6/SingleMuon/NanoV9Run2017B_{NANO_PROD_TAG}",
    ...
    'ZmumuPostVFP' : { 
        'filepaths' : ["{BASE_PATH}/../y2017v6/DYJetsToMuMu_H2ErratumFix_TuneCP5_13TeV-powhegMiNNLO-pythia8-photos/NanoV9MC2017_{NANO_PROD_TAG}"],
        'xsec' : common.xsec_ZmmPostVFP,
        'group': "Zmumu",
        "das_name" : "private"
    },    
    'DYJetsToMuMuMass10to50PostVFP' : {
        'filepaths' : ["{BASE_PATH}/../y2017v6/DYJetsToMuMu_M-10to50_H2ErratumFix_TuneCP5_13TeV-powhegMiNNLO-pythia8-photos/NanoV9MC2017_{NANO_PROD_TAG}"],
    ...
    'ZtautauPostVFP' : { #this sample needs to be produced using old Mass fix one
        'filepaths' : ["{BASE_PATH}/../y2017v6//DYJetsToTauTau_M-50_AtLeastOneEorMuDecay_massWgtFix_TuneCP5_13TeV-powhegMiNNLO-pythia8-photos/NanoV9MC2017_{NANO_PROD_TAG}"],
    ...
    'WplusmunuPostVFP' : { 
        'filepaths' : ["{BASE_PATH}/../y2017v6/WplusJetsToMuNu_H2ErratumFix_TuneCP5_13TeV-powhegMiNNLO-pythia8-photos/NanoV9MC2017_{NANO_PROD_TAG}"],
        'xsec' : common.xsec_WpmunuPostVFP,
        'group': "Wmunu",
        "das_name" : "private"
    },
    'WminusmunuPostVFP' : { 
        'filepaths' : ["{BASE_PATH}/../y2017v6/WminusJetsToMuNu_H2ErratumFix_TuneCP5_13TeV-powhegMiNNLO-pythia8-photos/NanoV9MC2017_{NANO_PROD_TAG}"],
    ...
    'TTLeptonicPostVFP' : { 
        'filepaths' : ["{BASE_PATH}/../y2017v6/TTTo2L2Nu_TuneCP5_13TeV-powheg-pythia8/NanoV9MC2017_{NANO_PROD_TAG}"],
        'xsec' : 88.29,
        'group' : "Top",
    ...
    'TTSemileptonicPostVFP' : { ##could not copy full stat of this sample due to lack of storage 
        'filepaths' : ["{BASE_PATH}/../y2017v6/TTToSemiLeptonic_TuneCP5_13TeV-powheg-pythia8/NanoV9MC2017_{NANO_PROD_TAG}"],
        'xsec' : 366.34,
        'group' : "Top",
    ...
    'SingleTschanLepDecaysPostVFP' : { 
        'filepaths' : ["{BASE_PATH}/../y2017v6/ST_s-channel_4f_leptonDecays_TuneCP5_13TeV-amcatnlo-pythia8/NanoV9MC2017_{NANO_PROD_TAG}"],
        'xsec' : 3.609,
        'group' : "Top",
    ...
    'SingleTtWAntitopPostVFP' : { 
        'filepaths' : ["{BASE_PATH}/../y2017v6/ST_tW_antitop_5f_NoFullyHadronicDecays_TuneCP5_13TeV-powheg-pythia8/NanoV9MC2017_{NANO_PROD_TAG}"],
    ...
    'SingleTtWTopPostVFP' : { 
        'filepaths' : ["{BASE_PATH}/../y2017v6/ST_tW_top_5f_NoFullyHadronicDecays_TuneCP5_13TeV-powheg-pythia8/NanoV9MC2017_{NANO_PROD_TAG}"],
        'xsec' : 19.55,
        'group' : "Top",
    ...
    'SingleTtchanAntitopPostVFP' : { 
        'filepaths' : ["{BASE_PATH}/../y2017v6/ST_t-channel_antitop_5f_InclusiveDecays_TuneCP5_13TeV-powheg-pythia8/NanoV9MC2017_{NANO_PROD_TAG}"],
        'xsec' : 80.0,
        'group' : "Top",
    ...
    'SingleTtchanTopPostVFP' : { 
        'filepaths' : ["{BASE_PATH}/../y2017v6/ST_t-channel_top_5f_InclusiveDecays_TuneCP5_13TeV-powheg-pythia8/NanoV9MC2017_{NANO_PROD_TAG}"],
        'xsec' : 134.2,
        'group' : "Top",
    ...
    ##
    'WWTo2L2NuPostVFP' : { 
        'filepaths' : ["{BASE_PATH}/../y2017v6/WWTo2L2Nu_TuneCP5_13TeV-powheg-pythia8/NanoV9MC2017_{NANO_PROD_TAG}"],
    ...
    'WWTo1L1Nu2QPostVFP' : { 
        'filepaths' : ["{BASE_PATH}/../y2017v6/WWTo1L1Nu2Q_4f_TuneCP5_13TeV-amcatnloFXFX-pythia8/NanoV9MC2017_{NANO_PROD_TAG}"],
    ...
    'WZTo3LNuPostVFP' : { 
        'filepaths' : ["{BASE_PATH}/../y2017v6/WZTo3LNu_TuneCP5_13TeV-amcatnloFXFX-pythia8/NanoV9MC2017_{NANO_PROD_TAG}"],
    ...
    'WZTo2Q2LPostVFP' : { 
        'filepaths' : ["{BASE_PATH}/../y2017v6/WZTo2Q2L_mllmin4p0_TuneCP5_13TeV-amcatnloFXFX-pythia8/NanoV9MC2017_{NANO_PROD_TAG}"],
    ...
    'WZTo1L1Nu2QPostVFP' : { 
        'filepaths' : ["{BASE_PATH}/../y2017v6/WZTo1L1Nu2Q_4f_TuneCP5_13TeV-amcatnloFXFX-pythia8/NanoV9MC2017_{NANO_PROD_TAG}"],
    ...
    'ZZTo2L2NuPostVFP' : { 
        'filepaths' : ["{BASE_PATH}/../y2017v6/ZZTo2L2Nu_TuneCP5_13TeV_powheg_pythia8/NanoV9MC2017_{NANO_PROD_TAG}"],
        'xsec' : 0.60,
        'group' : "Diboson",
    ...
    'ZZTo2Q2LPostVFP' : { 
        'filepaths' : ["{BASE_PATH}/../y2017v6/ZZTo2Q2L_mllmin4p0_TuneCP5_13TeV-amcatnloFXFX-pythia8/NanoV9MC2017_{NANO_PROD_TAG}"],
        'xsec' : 5.1,
        'group' : "Diboson",
    ...
    'QCDmuEnrichPt15PostVFP' : { #Not copied
        'filepaths' : ["{BASE_PATH}/../y2017v6/QCD_Pt-20_MuEnrichedPt15_TuneCP5_13TeV-pythia8/NanoV9MC2017_{NANO_PROD_TAG}/"],
        'xsec' : 238800,
        'group' : "QCD",
