...
if __name__ == '__main__':
    ...
    parser.add_argument("-i", "--moments", required=False, default=None, help="Moments file `w_z_moments.hdf` with coefficients produced in w_z_gen_dists.py histmaker")
    ...
    if args.moments is not None:
        ...
        # hcoeff = load_moments_coefficients(args.moments)
