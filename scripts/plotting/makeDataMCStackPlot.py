...
variation.add_argument("--varLabel", type=str, nargs='*', default=None, help="Label(s) of variation hist for plotting")
...
for h in args.hists:
    if any(x in h.split("-") for x in ["pt", "ptll", "mll", "ptVgen", "ptVGen"]):
